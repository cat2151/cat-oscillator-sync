/**
 * Smooth version AudioWorklet Processor as a bundleable module
 * This exports the processor code as a string that can be dynamically loaded
 */

export const SmoothWorkletProcessor = `
